document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    const elements = document.querySelectorAll(OBSERVED_SELECTORS.join(', '));
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "GB-Campaigns משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '4efa69e1-038f-453b-85ac-3b31cf2e92ca',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '4efa69e1-038f-453b-85ac-3b31cf2e92ca';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4efa69e1-038f-453b-85ac-3b31cf2e92ca';
